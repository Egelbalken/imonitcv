...
class Project(models.Model):
    ...
    # order the ordering on the projects - is showing the newest at the top.
    class Meta:
        ordering = ['-vote_ratio', '-vote_total', '-created']

    # Adding a try catch to prevent the app to crash when user delteing the image
    @property
    def imageURL(self):
        try:
            url =self.featured_image.url
            pathURL = "/staticfiles/images/default.jpg"
        except Exception :
