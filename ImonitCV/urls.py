...
# Here is the central routs in the application.
urlpatterns = [
    path('admin/', admin.site.urls),
    # adds the project apps routes
    path('projects/', include('projects.urls')),
    # adds the users apps routes
    path('', include('users.urls')),
    # adds the API module routes
    path('api/', include('api.urls')),

    # add classbased views that are inbuilt
